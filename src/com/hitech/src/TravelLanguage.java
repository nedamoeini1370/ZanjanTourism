...
public class TravelLanguage extends ActionBarActivity implements
android.view.View.OnClickListener {
    ...
    public static String [] prgmNameList ={"انگلیسی در زنجان","ترکی در زنجان","عربی در زنجان","انگلیسی در زنجان","ترکی در زنجان","عربی در زنجان"};
    public static String [] prgmCapitalNameList ={"English In Zanjan","Turkish In Zanjan","َArabic In Zanjan","English In Zanjan","Turkish In Zanjan","َArabic In Zanjan"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TravelLanguageListAdapter myAdapter = new TravelLanguageListAdapter(this, prgmNameList,prgmCapitalNameList);
